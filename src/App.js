        ...
        BABYLON.SceneLoader.Append("", reader.result, scene, function (scene) {                     
            ...
            var textureSelect = document.getElementById("texture-select-" + String(meshArray.length - 1));
              if (!textureSelect){
                ...
                textureSelect.style.color = "black"; 
...
export default (scene, meshArray, meshesCameraLimits) => (
  <div className="flex flex-col h-screen items-center justify-center bg-[#33334C]">
    <div className="flex flex-col gap-y-8 font-semibold text-white">
      <div className="flex gap-x-8 justify-center ">
        <span>Upload Model:</span>
        <input id="import-btn" type="file" className="" />
        <span>Upload Texture:</span>
        <input id="texture-import-btn" type="file" className="" />
      </div>
    ...
    <div id="model-button-part" className="flex gap-x-16">
    </div>
  </div>
);
